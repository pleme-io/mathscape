...
| [storage.md](storage.md) | Storage architecture: redb expression store, PostgreSQL (SeaORM), epoch transactions, memory budget |
...
| [service.md](service.md) | Service mode: HTTP endpoints, engine loop, Prometheus metrics, three binaries |
| [deployment.md](deployment.md) | K8s deployment: Docker image, Helm chart, FluxCD, substrate patterns |
| [discovery.md](discovery.md) | Discovery mining: epoch analysis, known-math mapping, representation data for React UI |
